% ---------------------------------------------------------------
% This code implements a network of 1000 Chen subsystems 
...
Subsystem = 1000; % Number of subsystems

initial = -1 * [2; 2; 2];   % Initial state vector [x_1; x_2; x_3]

n_states = 3;

%============== Subsystem matrices (A_i, B_i, D_i) (Chen) =================
% Chen parameters
teta1 = 35;
teta2 = 28;
teta3 = 3;
...
D_coeff = 0.00005; % Interconnection coefficient
...
arrayD = repmat(D,1 ,Subsystem-1); % Block matrix D_i 
...
bar_varkappa = n_states * 0.09  %In equation (11)
...
gamma_network = Subsystem * gamma

beta_network =  Subsystem *  beta
...
Comp = (ones(Subsystem) - eye(Subsystem)) * Delta;

disp('Cheking compostional condition:');


epsil = repmat(epsilon, 1, Subsystem);


Compostion = ones(1, Subsystem) * (Comp - diag(epsil)); % Compositionality condition in equation (23b)


Comp_numeric = double(Compostion);

% Check if any element in Comp_numeric is greater than 0
