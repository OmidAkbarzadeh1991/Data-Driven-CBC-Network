% ---------------------------------------------------------------
% This code implements the subsystem 301.
% ---------------------------------------------------------------
clc
clear
close all
...
initial = 4 * [-0.1; -0.1];  % Initial state vector [x_1; x_2]
...
Barrier = var_x.' * P * var_x; % Barrier function

gamma  = monomials(var_x,0);  % Sub-barrier function
